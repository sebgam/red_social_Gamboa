 ...
 * @author  		Raymond Benc
 * @package  		Module_Feed
 * @version 		$Id: display.html.php 5098 2013-01-07 14:44:40Z Miguel_Espinoza $
 */
							...
							
{
 ...
 / <?php $aYears = range(2017, 1900);   $aParams = (isset($aParams) ? $aParams : Phpfox::getLib('phpfox.request')->getArray('val')); ?>		<select name="val[start_year]" id="start_year" class="js_datepicker_year">
...
<?php else: ?>
<?php /* Cached: January 28, 2017, 4:07 pm */  if (isset ( $this->_aVars['bIsViewingComments'] ) && $this->_aVars['bIsViewingComments']): ?>
...
<?php /* Cached: January 28, 2017, 4:07 pm */  if (Phpfox ::getParam('like.show_user_photos')): ?>
