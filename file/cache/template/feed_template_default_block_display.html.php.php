...
<?php else: ?>
<?php /* Cached: January 26, 2017, 8:16 pm */  if (isset ( $this->_aVars['bIsViewingComments'] ) && $this->_aVars['bIsViewingComments']): ?>
...
<?php /* Cached: January 26, 2017, 8:16 pm */  if (Phpfox ::getParam('like.show_user_photos')): ?>
