 ...
 * @version 		$Id: browse.class.php 5141 2013-01-15 10:59:09Z Miguel_Espinoza $
 */
class Photo_Service_Browse extends Phpfox_Service 
{
	...
	public function query()
	{
		...
		if (Phpfox::isModule('like'))
		{
			...
			->leftJoin(Phpfox::getT('like'), 'l', 'l.type_id = "photo" AND l.item_id = photo.photo_id AND photo.user_id = ' . Phpfox::getUserId() . '')
