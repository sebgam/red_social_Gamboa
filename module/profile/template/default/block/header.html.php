 ...
 * @version 		$Id: header.html.php 5119 2013-01-11 12:11:07Z Miguel_Espinoza $
 */
...
?>
	<div{if Phpfox::getService('profile')->timeline()} class="profile_timeline_header_holder"{/if}>
		<div class="profile_header{if Phpfox::getService('profile')->timeline()} profile_timeline_header{/if}{if empty($aUser.cover_photo) && (!isset($aUser.cover_photo_id) || $aUser.cover_photo_id < 1)} no_cover_photo{/if}">
			...
			<div class="profile_header_inner{if Phpfox::getService('profile')->timeline()} profile_header_timeline{/if}">				
				...
				<h1 style="width:400px;">
					{if isset($aUser.user_name)}
					    <a href="{url link=$aUser.user_name}" title="{$aUser.full_name|clean}">
				...
				<div class="profile_info">
					...
					{/if}
					{if isset($birthdate_display) && is_array($aUser.birthdate_display) && count($aUser.birthdate_display)}
