 ...
 * @author  		Raymond_Benc
 * @package 		Phpfox
 * @version 		$Id: add.html.php 5143 2013-01-15 14:16:21Z Miguel_Espinoza $
 */
	...
	<form method="post" action="{url link='pages.add'}{if $bIsNewPage}{$sStep}/new_1/{/if}" enctype="multipart/form-data">
		...
		<div id="js_pages_block_detail" class="js_pages_block page_section_menu_holder">
			...
			<div class="table">
				...
				<div class="table_right">
					<input type="radio" value="1" name="val[use_timeline]" {value type='radio' id='use_timeline' default='1' selected='true'} id="rdo_timeline_1"> <label for="rdo_timeline_1">Yes</label>
					<input type="radio" value="0" name="val[use_timeline]" {value type='radio' id='use_timeline' default='0'}id="rdo_timeline_0"> <label for="rdo_timeline_0">No</label>
				</div>
			</div>
